...
class _CoreScreenState extends State<CoreScreen> {
  ...
  void _goToSkiabsScreen() {
    Navigator.push(context, MaterialPageRoute(builder: (context) => SkiabsScreen()));
  }
      ...
      body: Column(
        ...
        children: [
          if (!_isTimerCompleted)
            Image.asset('assets/animations/corestrengthening.gif', height: 300),
          SizedBox(height: 20),
          Text(
            'CORE STRENGTHENING',
