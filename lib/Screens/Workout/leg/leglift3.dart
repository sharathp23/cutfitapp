...
class LegLift3Screen extends StatelessWidget {
  const LegLift3Screen({Key? key}) : super(key: key);
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => FrontAndBackLunges2Screen()),
                            );
                          },
                          child: Text('OK'),
                        ),
