...
class DonkeyKicks2Screen extends StatelessWidget {
  const DonkeyKicks2Screen({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
           ...
           SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                double durationInMinutes = 0.95; // Change this to the actual duration of the exercise
