...
class SkiabsScreen extends StatefulWidget {
  @override
  _SkiabsScreenState createState() => _SkiabsScreenState();
}

class _SkiabsScreenState extends State<SkiabsScreen> {
      ...
      body: Column(
        ...
        children: [
          if (!_isTimerCompleted)
            Image.asset('assets/animations/skiabs.gif', height: 300),
          SizedBox(height: 20),
          Text(
            'Ski Abs',
