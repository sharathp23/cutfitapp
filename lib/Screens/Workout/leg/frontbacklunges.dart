...
class FrontAndBackLunges2Screen extends StatelessWidget {
  const FrontAndBackLunges2Screen({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
           ...
           SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                double durationInMinutes = 1.15; // Change this to the actual duration of the exercise
