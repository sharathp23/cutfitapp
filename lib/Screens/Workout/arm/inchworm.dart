...
class InchwormScreen extends StatelessWidget {
  const InchwormScreen({Key? key}) : super(key: key);
  static const double MET = 3.8;
  static const double WEIGHT_KG = 70.0;
  static const int DURATION_SECONDS = 70;
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/inchworm.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
