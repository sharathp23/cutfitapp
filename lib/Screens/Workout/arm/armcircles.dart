...
class ArmCirclesScreen extends StatefulWidget {
  @override
  _ArmCirclesScreenState createState() => _ArmCirclesScreenState();
}

class _ArmCirclesScreenState extends State<ArmCirclesScreen> {
  ...
  void _navigateToTriceps3Screen() {
    Navigator.push(
      context,
...
context,
MaterialPageRoute(
builder: (context) => Triceps3Screen(),
),
);
},
child: Text('OK'),
