...
class OneArmTricepsScreen extends StatelessWidget {
  const OneArmTricepsScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/onearmtriceppushups.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => JumpingJack5Screen()),
                            );
                          },
                          child: Text('OK'),
                        ),
