...
class SpidermanPlankScreen extends StatelessWidget {
  const SpidermanPlankScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/spidermanplank.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => PunchesScreen()),
                            );
                          },
                          child: Text('OK'),
                        ),
