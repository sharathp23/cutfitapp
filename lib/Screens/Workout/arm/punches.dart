...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: PunchesScreen(),
      routes: {
        '/SpidermanPlank': (context) => SpidermanPlankScreen(),
      },
    );
  }
}
...
class PunchesScreen extends StatefulWidget {
  @override
  _PunchesScreenState createState() => _PunchesScreenState();
}
...
void _startTimer() {
  ...
  void _goToPushUp3Screen() {
    Navigator.push(context, MaterialPageRoute(builder: (context) => PushUp3Screen()));
  }
      ...
      body: Column(
        ...
        children: [
          if (!_isTimerCompleted)
            Image.asset('assets/animations/punches.gif', height: 300),
          SizedBox(height: 20),
          Text(
            'Punches',
