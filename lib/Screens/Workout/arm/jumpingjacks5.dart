...
class JumpingJack5Screen extends StatefulWidget {
  @override
  _JumpingJack5ScreenState createState() => _JumpingJack5ScreenState();
}

class _JumpingJack5ScreenState extends State<JumpingJack5Screen> {
