...
class WeightedDonkeyKickScreen extends StatelessWidget {
  const WeightedDonkeyKickScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/weighteddonkeykicks.gif',
              height: 300,
              width: 300,
            ),
            SizedBox(height: 20),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => Squats2Screen()),
                            );
                          },
                          child: Text('OK'),
                        ),
