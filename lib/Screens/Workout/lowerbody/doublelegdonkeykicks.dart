...
class DoubleLegDonkeyKicksScreen extends StatelessWidget {
  const DoubleLegDonkeyKicksScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/doublelegdonkeykicks.gif',
              height: 300,
              width: 300,
            ),
            SizedBox(height: 20),
