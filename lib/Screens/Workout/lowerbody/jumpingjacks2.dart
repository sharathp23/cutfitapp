...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: JumpingJack2Screen(),
    );
  }
}

class JumpingJack2Screen extends StatefulWidget {
  @override
  _JumpingJack2ScreenState createState() => _JumpingJack2ScreenState();
}

class _JumpingJack2ScreenState extends State<JumpingJack2Screen> {
