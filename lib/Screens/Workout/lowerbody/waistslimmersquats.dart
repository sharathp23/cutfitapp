...
class WaistSlimmerSquatsScreen extends StatelessWidget {
  const WaistSlimmerSquatsScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/waistslimmerdaysquats.gif',
              height: 300,
              width: 300,
            ),
            SizedBox(height: 20),
            ...
            ElevatedButton(
              onPressed: () {
                double durationInMinutes = 0.9; // Change this to the actual duration of the exercise
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) =>FrontAndBackLungesScreen()),
                            );
                          },
                          child: Text('OK'),
                        ),
