...
class FrontAndBackLungesScreen extends StatelessWidget {
  const FrontAndBackLungesScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/frontandbacklunges.gif',
              height: 300,
              width: 300,
            ),
            SizedBox(height: 20),
            ...
            ElevatedButton(
              onPressed: () {
                double durationInMinutes = 1.1; // Change this to the actual duration of the exercise
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => WeightedDonkeyKickScreen()),
                            );
                          },
                          child: Text('OK'),
                        ),
