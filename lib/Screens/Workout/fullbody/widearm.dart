...
class WideArmPushUpScreen extends StatelessWidget {
  const WideArmPushUpScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/widearmpushups.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => DeclinePushUpScreen()),
                            );
                          },
                          child: Text('OK'),
                        ),
