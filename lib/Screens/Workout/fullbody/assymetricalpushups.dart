...
class AssymetricalPushUpScreen extends StatelessWidget {
  const AssymetricalPushUpScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/assymetricalpushup.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
            Text(
              'ASSYMETRICAL PUSH UP',
              style: TextStyle(
                fontSize: 24,
