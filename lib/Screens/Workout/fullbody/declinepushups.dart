...
class DeclinePushUpScreen extends StatelessWidget {
  const DeclinePushUpScreen({Key? key}) : super(key: key);

  // Constants for calculating calories burned
  static const double MET = 3.8;
  static const double WEIGHT_KG = 70.0;
  static const int DURATION_SECONDS = 90;
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/declinepushups.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => AssymetricalPushUpScreen()),
                            );
                          },
                          child: Text('OK'),
                        ),
