...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: JumpingJack6Screen(),
      routes: {
        '/ArmSwings2': (context) => ArmSwings2Screen(),
      },
    );
  }
}

class JumpingJack6Screen extends StatefulWidget {
  @override
  _JumpingJack6ScreenState createState() => _JumpingJack6ScreenState();
}

class _JumpingJack6ScreenState extends State<JumpingJack6Screen> {
