...
class KneePushUp4Screen extends StatelessWidget {
  const KneePushUp4Screen({Key? key}) : super(key: key);

// Constants for calculating calories burned
  static const double MET = 3.8;
  static const double WEIGHT_KG = 70.0;
  static const int DURATION_SECONDS = 100;
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/kneepushups.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
