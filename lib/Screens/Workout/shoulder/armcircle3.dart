...
class ArmCircles3Screen extends StatefulWidget {
  @override
  _ArmCircles3ScreenState createState() => _ArmCircles3ScreenState();
}

class _ArmCircles3ScreenState extends State<ArmCircles3Screen> {
  ...
  void _navigateToKneePushUp3Screen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => KneePushUp3Screen()),
    );
  }
