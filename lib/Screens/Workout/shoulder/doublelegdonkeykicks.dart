...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DoublelegDonkeyKicksScreen(),
      routes: {
        '/KneePushUp4': (context) => KneePushUp4Screen(),
      },
    );
  }
}

class DoublelegDonkeyKicksScreen extends StatefulWidget {
  @override
  _DoublelegDonkeyKicksScreenState createState() => _DoublelegDonkeyKicksScreenState();
}

class _DoublelegDonkeyKicksScreenState extends State<DoublelegDonkeyKicksScreen> {
...
void _startTimer() {
  ...
  void _goToKneePushUp4Screen() {
    Navigator.push(context, MaterialPageRoute(builder: (context) => KneePushUp4Screen()));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Double Leg Donkey Kicks'),
      ),
      body: Column(
        ...
        children: [
          if (!_isTimerCompleted)
            Image.asset('assets/animations/doublelegdonkeykicks.gif', height: 300),
          SizedBox(height: 20),
          Text(
