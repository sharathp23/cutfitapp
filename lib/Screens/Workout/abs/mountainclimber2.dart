...
class MountainClimber2Screen extends StatelessWidget {
  const MountainClimber2Screen({Key? key}) : super(key: key);
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                double durationInMinutes = 1.5; // Change this to the actual duration of the exercise
