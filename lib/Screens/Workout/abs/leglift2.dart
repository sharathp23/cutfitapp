...
class LegLift2Screen extends StatelessWidget {
  const LegLift2Screen ({Key? key}) : super(key: key);

  static const double MET = 3.8;
  static const double WEIGHT_KG = 70.0;
  static const int DURATION_SECONDS = 75;
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => PlankJacks2Screen()),
                            );
                          },
                          child: Text('OK'),
                        ),
