...
class PlankJacksScreen extends StatelessWidget {
  const PlankJacksScreen ({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/animations/plankJacks.gif',
              height: 200,
              width: 200,
            ),
            SizedBox(height: 20),
                      ...
                      actions: [
                        TextButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => MountainClimber3Screen()),
                            );
                          },
                          child: Text('OK'),
                        ),
