...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: JumpingJack4Screen(),
    );
  }
}

class JumpingJack4Screen extends StatefulWidget {
  @override
  _JumpingJack4ScreenState createState() => _JumpingJack4ScreenState();
}

class _JumpingJack4ScreenState extends State<JumpingJack4Screen> {
